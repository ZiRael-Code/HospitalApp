...
class OrderPrescriptionSummary extends StatefulWidget {
  ...
  @override
  State<OrderPrescriptionSummary> createState() => _OrderPrescriptionSummaryState();
}
        ...
        body: Padding(padding: EdgeInsets.all(12),
          child: Column(
            children: [
              ...
              Column(
                children: [
                  Text("Randy Blue pharmacy", style: TextStyle(fontSize: 17),),
                  SizedBox(height: 5,),
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                     Text("View pharmacy",  style: TextStyle(color: Colors.blue)),
              ...
              Row(
                children: [
                  ...
                  Text("Ibuprofen 500mg x 24", style: TextStyle(fontSize: 16, color: Colors.blue, fontWeight: FontWeight.w500),)
                ],
              ),
              SizedBox(height: 25,),
              Row(
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text("N1,500", style: TextStyle(fontSize: 16, color: Colors.blue, fontWeight: FontWeight.w500),)
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text("12 per pack", style: TextStyle(fontSize: 16, color: Colors.blue, fontWeight: FontWeight.w500),)
