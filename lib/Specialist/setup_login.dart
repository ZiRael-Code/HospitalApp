...
import 'package:hospital_appp/dynamic_success.dart';
                    ...
                    child:  ElevatedButton(
                      onPressed: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) =>
                                DynamicSuccess(text: "You have successfully setup custom logins for your specialists. You can edit this anytime and set different passwords for different individuals.",
                                  buttonText: "done",
