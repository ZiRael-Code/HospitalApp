...
class _CheckoutScreen extends State<Checkout> {
                ...
                child: Align(
                  child: Column(
                    children: [
                      ...
                      deliverMethod(
                          text: 'Not set yet', header: 'Delivery method'),
                      GestureDetector(
                        child: deliverMethod(
                            text: 'Not set yet', header: 'Address'),
                        onTap: () {
  ...
  info({required String type, required String des}) {
    ...
    return Column(
      ...
      children: [
        Text(
          ...
          style: TextStyle(
              color: Colors.black, fontSize: getFontSize(18, context)),
        ),
        ...
        ElevatedButton(
          onPressed: () {
            ...
            Navigator.of(context).push(
                MaterialPageRoute(builder: (builder) => SelectYourLocation()));
          },
          style: ElevatedButton.styleFrom(
            backgroundColor: Colors.blue,
        ...
        ElevatedButton(
          onPressed: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (builder) => Selectpickuplocation()));
          },
          style: ElevatedButton.styleFrom(
              fixedSize: Size.fromWidth(MediaQuery.of(context).size.width),
              side: BorderSide(
                  width: getFontSize(1, context), color: Colors.blue),
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(9),
              ),
          ...
          child: Padding(
            ...
            child: Text(
              ...
              style: TextStyle(
                  color: Colors.blue, fontSize: getFontSize(18, context)),
            ),
          ),
        ),
      ],
