        ...
        body: Padding(
          ...
          child: Column(
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(top: getFontSize(140, context), bottom: getFontSize(10, context)),
              ...
              Padding(
                padding: EdgeInsets.only(top: getFontSize(10, context), bottom: getFontSize(20, context)),
                child: Container(
                  ...
                  child: Center(
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          "Copy",
                          style: TextStyle(fontSize: getFontSize(12, context), color: Colors.blue),
                        )
                      ],
                    ),
                  ),
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(fontSize: getFontSize(10, context), color: Colors.grey),
                ),
              ),
              Padding(
