...
import 'package:hospital_appp/decive%20distribution/card_details.dart';
import 'package:hospital_appp/decive%20distribution/deviced_ordered.dart';
        ...
        body: Padding(
          ...
          child:  Column(
              children: [
                ...
                GestureDetector(
                  onTap: ()=> Navigator.of(context).push(MaterialPageRoute(builder: (builder)=>CardDetails())),
                  child:
                buildPaymentOption(
