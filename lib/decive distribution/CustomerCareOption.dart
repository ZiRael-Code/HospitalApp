import 'package:hospital_appp/Account/VitChatBot.dart';
    ...
    return Scaffold(
        ...
        body: Container(
          padding: EdgeInsets.only(
              left: getFontSize(15, context), right: getFontSize(15, context)),
          child: Column(children: [
            GestureDetector(
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => VitChatBot()));
              },
              child: careOption(
                  careName: Row(
                    children: [
  ...
  careOption({required careName, required careImgPath, required description}) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: Color(0xFFE5E5E5), width: getFontSize(1, context)),
      ),
