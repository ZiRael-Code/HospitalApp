import 'package:hospital_appp/MainScreen/Dashboard.dart';
import 'package:hospital_appp/Specialist/ConfirmLocation.dart';
              ...
              child: Expanded(
                child: ListView.builder(
                  itemCount: filteredAddresses.length +
                      1, // Extra item for the additional row
                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (builder) => ConfirmLocation()));
                      },
                      child: addressWidget(
              ...
              child: Row(
                children: [
                  Container(
                    padding: EdgeInsets.all(12),
                    decoration: BoxDecoration(
                        color: Color(0xffE2EDFF), shape: BoxShape.circle),
                    child: Icon(
                      Icons.location_on,
                      color: Colors.blue,
                    ),
