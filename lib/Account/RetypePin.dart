...
class _AppointmentPaymentScreen extends  State<RetypePin> {
                  ...
                  Column(
                    children: [
                      ...
                      Container(
                        ...
                        child:
                        Align(child: Text("Retype PIN.", textAlign: TextAlign.center,
                          style: TextStyle(
  ...
  number({
    ...
    return GestureDetector(
      ...
      setState(() {
        if (pin.length == 4) {
          Navigator.push(context, MaterialPageRoute(builder: (context) => PinResetSucess()));
