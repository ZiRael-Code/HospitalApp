...
class SelectFromContactListPharmacy extends StatefulWidget {
  const SelectFromContactListPharmacy({super.key});

  @override
  State<SelectFromContactListPharmacy> createState() =>
      _SelectFromContactListPharmacyState();
}

class _SelectFromContactListPharmacyState
    extends State<SelectFromContactListPharmacy> with TickerProviderStateMixin {
